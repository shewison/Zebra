    ...
    public unsafe partial class FirmwareUpdateEvent : NSObject
    {
        ...
        public virtual int CurrentRecord
        {
            ...
            get
            {
                if (IsDirectBinding)
                {
                    return global::ApiDefinition.ZebraMessaging.int_objc_msgSend(this.Handle, Selector.GetHandle("currentRecord"));
                }
                else
                {
                    return global::ApiDefinition.ZebraMessaging.int_objc_msgSendSuper(this.SuperHandle, Selector.GetHandle("currentRecord"));
                }
            }
        ...
        public virtual int MaxRecords
        {
            ...
            get
            {
                if (IsDirectBinding)
                {
                    return global::ApiDefinition.ZebraMessaging.int_objc_msgSend(this.Handle, Selector.GetHandle("maxRecords"));
                }
                else
                {
                    return global::ApiDefinition.ZebraMessaging.int_objc_msgSendSuper(this.SuperHandle, Selector.GetHandle("maxRecords"));
                }
            }
        ...
        [BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
        public virtual SbtScannerInfo ScannerInfo
        {
            ...
            get
            {
                ...
                if (IsDirectBinding)
                {
                    ret = Runtime.GetNSObject<SbtScannerInfo>(global::ApiDefinition.ZebraMessaging.IntPtr_objc_msgSend(this.Handle, Selector.GetHandle("scannerInfo")));
                }
                else
                {
                    ret = Runtime.GetNSObject<SbtScannerInfo>(global::ApiDefinition.ZebraMessaging.IntPtr_objc_msgSendSuper(this.SuperHandle, Selector.GetHandle("scannerInfo")));
                }
                return ret;
            }
            ...
            set
            {
                ...
                if (IsDirectBinding)
                {
                    global::ApiDefinition.ZebraMessaging.void_objc_msgSend_IntPtr(this.Handle, Selector.GetHandle("setScannerInfo:"), value.Handle);
                }
                else
                {
                    global::ApiDefinition.ZebraMessaging.void_objc_msgSendSuper_IntPtr(this.SuperHandle, Selector.GetHandle("setScannerInfo:"), value.Handle);
                }
            }
        }
        ...
        public virtual int Size
        {
            ...
            get
            {
                if (IsDirectBinding)
                {
                    return global::ApiDefinition.ZebraMessaging.int_objc_msgSend(this.Handle, Selector.GetHandle("size"));
                }
                else
                {
                    return global::ApiDefinition.ZebraMessaging.int_objc_msgSendSuper(this.SuperHandle, Selector.GetHandle("size"));
                }
            }
        ...
        [BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
        public virtual SbtFwUpdateResult Status
        {
            [Export("status")]
            get
            {
                if (IsDirectBinding)
                {
                    return (SbtFwUpdateResult)global::ApiDefinition.ZebraMessaging.UInt32_objc_msgSend(this.Handle, Selector.GetHandle("status"));
                }
                else
                {
                    return (SbtFwUpdateResult)global::ApiDefinition.ZebraMessaging.UInt32_objc_msgSendSuper(this.SuperHandle, Selector.GetHandle("status"));
                }
            }
        ...
        public virtual int SwComponent
        {
            ...
            get
            {
                if (IsDirectBinding)
                {
                    return global::ApiDefinition.ZebraMessaging.int_objc_msgSend(this.Handle, Selector.GetHandle("swComponent"));
                }
                else
                {
                    return global::ApiDefinition.ZebraMessaging.int_objc_msgSendSuper(this.SuperHandle, Selector.GetHandle("swComponent"));
                }
            }
