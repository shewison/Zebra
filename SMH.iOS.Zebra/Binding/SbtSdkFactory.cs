...
namespace SMH.iOS.Zebra {
	...
	public unsafe partial class SbtSdkFactory : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static IISbtSdkApi CreateSbtSdkApiInstance ()
		{
			return  Runtime.GetINativeObject<ISbtSdkApiWrapper> (global::ApiDefinition.ZebraMessaging.IntPtr_objc_msgSend (class_ptr, Selector.GetHandle ("createSbtSdkApiInstance")), false);
		}
